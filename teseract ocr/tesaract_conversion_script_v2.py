...
# 1 = Automatic page segmentation with Orientation and Script Detection (OSD).
#     Detects multi-column layouts and reads in correct order (col 1 then col 2).
# 3 = Fully automatic page segmentation (no OSD) — fallback if 1 gives bad results.
# 6 = Single uniform block of text — use for single-column pages only.
PSM = 1
